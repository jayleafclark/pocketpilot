      ...
      {open && (
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-border">
            <div>
              <h3 className="font-semibold text-t1" style={{ fontSize: 15 }}>Ask PocketPilot</h3>
              <p className="text-t3" style={{ fontSize: 12, marginTop: 2 }}>Powered by Claude — Sprint 2</p>
            </div>
            <button
          ...
          <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3">
            {messages.length === 0 && (
              <div className="flex-1 flex items-center justify-center">
                <p className="text-t4 text-center" style={{ fontSize: 14, padding: "0 24px" }}>
          ...
          <div className="p-3 border-t border-border">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-xl border border-border bg-bg text-t1 outline-none"
                style={{ padding: "10px 14px", fontSize: 14, fontFamily: "var(--font-body)" }}
              />
              <button
                onClick={send}
